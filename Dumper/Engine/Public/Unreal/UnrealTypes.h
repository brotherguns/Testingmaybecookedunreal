...
private:
	// Function pointer type is the same for all platforms (ARM64 uses the same calling convention as x86-64 for this)
...
public:
	/* Windows-only signature-based init */
	static void Init_Windows(bool bForceGNames = false);

	/* Apple/ARM64 signature-based init */
	static void Init_Apple(bool bForceGNames = false);
...
private:
	...
	static void* TryFindApendStringBackupStringRef_Apple();
