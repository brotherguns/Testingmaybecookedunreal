...
#include "Platform/Private/PlatformApple.h"

namespace Platform = PlatformApple;

#define PLATFORM_APPLE

// A macro to append the correct postfix for this platform to a function name and call the function with the supplied parameters.
#define CALL_PLATFORM_SPECIFIC_FUNCTION(FunctionName, ...) FunctionName##_Apple(__VA_ARGS__)
